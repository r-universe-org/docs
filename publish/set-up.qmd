...
### One user, several registry files?

You **cannot** manage several R-universes from one single GitHub account or organization.
If you want to have, say, a development and a production R-universes, you need to manage them from two GitHub organizations.

Also check out [R-multiverse](https://r-multiverse.org/) (and other networks such as CRAN or Bioconductor) that could be the way for you to publish your packages for production.
